...
package com.trm.trmclient.Utils.Fayeclient.Websocket;
      ...
      try {
         ...
         do {
            ...
            if (len > 0) {
               ...
               ALog.d(DEBUG, TAG, "run() : ConnectionLost");
          ...
          ALog.d(DEBUG, TAG, "run() : WebSocketException (" + e.toString() + ")");
         ...
         ALog.d(DEBUG, TAG, "run() : Exception (" + e.toString() + ")");
